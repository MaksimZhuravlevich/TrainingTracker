...
class ExerciseLog(models.Model):
    ...
    weight = models.FloatField(validators=[MinValueValidator(1), MaxValueValidator(300)])
    reps = models.PositiveIntegerField(validators=[MinValueValidator(1), MaxValueValidator(300)])
    sets = models.PositiveIntegerField(validators=[MinValueValidator(1), MaxValueValidator(30)])
...
class UserProgress(models.Model):
    ...
    current_program = models.ForeignKey(
        'programs.TrainingProgram', null=True, blank=True, on_delete=models.SET_NULL
    )
